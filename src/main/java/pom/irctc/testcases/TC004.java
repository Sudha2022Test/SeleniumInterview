...
public class TC004 extends ProjectWrappers{
	...
	public void beforeClass() {
		testCaseName="TC004";
		testCaseDescription="To verify if user is able to Book hotels using OTP validation";
		author="Sudha";
		category="Smoke";
		browserName="Chrome";
	...
	public void BookHotelsOTPValidation() {
		...
		.selGST("No")
		.verifyHotelName("OYO Townhouse 359 Begumpet")
		.waitForPageLoad(1000)
		.verifyHotelPrice("₹ 18960")
		.clickOnContinue()
		.currentWindowNavigation()
		.clickTerms()
		.clickOnMakePayment()
		.currentWindowNavigation()
		.clickOnVerify()
		.verifyOtpMessage("otp is required.");
